    ...
    <el-card>
      <el-tabs v-model="activeName" @tab-click="handleClick">
        <el-tab-pane label="题目" name="question">
          ...
          <div class="Smallwords">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;θ3：经济状况一般、竞争对手推出一种竞争产品。
          </div>
          <div class="Smallwords">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;θ4：经济繁荣、竞争对手无反应。</div>
          <div class="Smallwords">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;θ5：经济繁荣、竞争对手推出一种竞争产品。
          </div>
        ...
        <el-tab-pane label="最大最小法(Wald法)" name="first">
          ...
          <el-card>
            ...
            <el-row>
              <div align="center">
                <el-table :data="tableData1" style="width: 78%;margin-top: 10px">
                  <el-table-column label="净现值(单位：百万元)">
                ...
                <span class="Smallwords right">
                        结果：<el-input size="medium" v-model="result1" style="width: 25%;margin-top: 10px"></el-input>
                    </span>
              </div>
            </el-row>
          </el-card>
        ...
        <el-tab-pane label="最大最大法" name="second">
          <el-card>
            ...
            <div class="Smallwords">方案/状态表:</div>
            <div align="center">
              <el-table :data="tableData" style="width: 78%;margin-top: 10px">
                <el-table-column label="净现值(单位：百万元)">
                  <el-table-column prop="plan" label="方案\状态" width="120"></el-table-column>
                  <el-table-column v-if="1<=newform.state" prop="stateone" label="θ1">
                    <template slot-scope="scope">
          ...
          <el-card>
            ...
            <div align="center">
              <el-table :data="tableData2" style="width: 78%;margin-top: 10px">
                <el-table-column label="净现值(单位：百万元)">
                  <el-table-column prop="plan" label="方案" width="100"></el-table-column>
              ...
              <span class="Smallwords right">
                        结果：<el-input size="medium" v-model="result2" style="width: 25%;margin-top: 10px"></el-input>
                    </span>
            </div>
          </el-card>
        </el-tab-pane>
        <el-tab-pane label="赫维斯基法(Hurwicz法)" name="third">
          ...
          <el-card>
            ...
            <el-table :data="tableData3" style="width: 402px;margin-top: 10px">
              <el-table-column label="净现值(单位：百万元)">
            ...
            <span class="Smallwords right">
                        结果：<el-input size="medium" v-model="result3" style="width: 25%;margin-top: 10px;"></el-input>
                    </span>
          </el-card>
        </el-tab-pane>
        <el-tab-pane label="拉普拉斯法(Laplace法)" name="fourth">
          ...
          <el-card>
            ...
            <div align="center">
              <el-table :data="tableData41" style="width: 78%;margin-top: 10px">
                <el-table-column label="净现值(单位：百万元)">
                  <el-table-column prop="plan" label="方案" width="100px"></el-table-column>
              ...
              <span class="Smallwords right" style="margin-top: 10px">
                        结果：<el-input size="medium" v-model="result41" style="width: 25%;margin-top: 10px"></el-input>
                    </span>
            </div>
          </el-card>
          <el-card>
            <span class="midTitle">改进的拉普拉斯法(Laplace法)：</span>
            ...
            <div align="center">
              <el-table :data="tableData42" style="width: 78%">
                <el-table-column label="净现值(单位：百万元)">
                  <el-table-column prop="plan" label="方案" width="100px"></el-table-column>
                  <el-table-column prop="result" label="期望值" width="100px">
                    <!--                                <template slot-scope="scope">-->
              ...
              <span class="Smallwords right">
                        结果：<el-input size="medium" v-model="result42" style="width: 25%;margin-top: 10px"></el-input>
                    </span>
            </div>
          </el-card>
        </el-tab-pane>
        <el-tab-pane label="最小最大后悔值法" name="fifth">
          ...
          <el-card>
            ...
            <div align="center">
              <el-table :data="tableData5" style="width: 78%;margin-top: 10px">
                <el-table-column label="净现值(单位：百万元)">
                  <el-table-column prop="plan" label="方案\状态" width="120"></el-table-column>
                  <el-table-column v-if="1<=newform.state" prop="stateone" label="θ1">
                    <!--                                <template slot-scope="scope">-->
              ...
              <span class="Smallwords right">
                        结果：<el-input size="medium" v-model="result5" style="width: 25%;margin-top: 10px"></el-input>
                    </span>
            </div>
          </el-card>
        </el-tab-pane>
        <el-tab-pane label="结果" name="result" lazy>
          <div class="Smallwords">最终结果：
            <el-button type="primary" @click="handleCommand" size="small">
              展示折线图
            </el-button>
          </div>
          <div>
          ...
          <div style="float: right;">
            <el-button style="margin-top: 20px; margin-bottom: 20px;margin-right: 10px;" type="primary"
                       @click="dialogVisible = true">预览
            </el-button>
            <el-button style="margin-top: 20px; margin-bottom: 20px;margin-left: 10px" type="primary"
                       @click="submitResult">保存
            </el-button>
            <el-button style="margin-top: 20px; margin-bottom: 20px;margin-left: 10px" type="primary"
                       @click="dialogVisibleaa = true" :disabled="isnotOK1">上传
            </el-button>
          </div>
...
export default {
  ...
  data() {
    return {
      chartData: {
        columns: ['方案', '最大最小法', '最大最大法', '赫维斯基法', '拉普拉斯法', '改进的拉普拉斯法', '最小最大后悔值法'],
        rows: []
      },
    ...
    handleCommand() {
      ...
      for (let tmp = 0; tmp < length; tmp++) {
        this.chartData.rows.push({
          方案: this.xname[tmp],
          最大最小法: this.tableData1[tmp].worst,
          最大最大法: this.tableData2[tmp].best,
          赫维斯基法: this.tableData3[tmp].best,
          拉普拉斯法: this.tableData41[tmp].result,
          改进的拉普拉斯法: this.tableData42[tmp].result,
          最小最大后悔值法: this.tableData5[tmp].result,
        })
      }
      console.log("绘制完成")
