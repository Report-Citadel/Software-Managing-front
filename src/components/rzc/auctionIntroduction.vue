            ...
            <div style="width:100%;">
              <el-button type="primary" @click="Exit()" style="float:left;">←退出</el-button>
                   ...
                   <p></p>
                    ...
                    <div style="width:100%">
  <div class="eachAuction" v-for="item in auctions" :key="item.auctionId">
                        ...
                        <el-col :span="12"><div class="AuctionIntroduction">
                            <el-card class="box-card" >
                                <div class="text item">
                                    ...
                                    <el-row><span style="width:auto; display:block; text-align:left ;line-height:30px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        本次拍卖的系统是实验教学管理系统，本次拍卖根据二级价格密封拍卖法展开，学生点击参与实验后可以根据意愿出价。出价后，学生可以查看相关拍卖数据，得出结论后完成实验报告的填写。</span></el-row>
                                        <el-row><span style="width:auto; display:block; text-align:left ;line-height:30px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        实验教学系统旨在为师生提供一个线上教学平台，学生可以登录系统下载课件并学习、参与课程项目作业、参与对抗练习，以此巩固课堂教学内容。
                                        教师可以在系统中开设课程、上传课件、发布课程实验项目、批改作业实验项目、管理成绩等，保障实验教学课程的顺利进行和有效管理。</span></el-row>
                                </div>
                            </el-card>
                        </div></el-col>
